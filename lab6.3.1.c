...
/* Лабораторная работа 6. Дополнительное задание 1
...
int main() {
	...
	if (arr[0].month < 10 && arr[1].month > 10) printf_s("Дата, предшествующая %d.0%d: %d.%d\n", arr[0].day, arr[0].month, arr[1].day, arr[1].month);
	if (arr[0].month > 10 && arr[1].month < 10) printf_s("Дата, предшествующая %d.%d: %d.0%d\n", arr[0].day, arr[0].month, arr[1].day, arr[1].month);
	if (arr[0].month < 10 && arr[1].month < 10) printf_s("Дата, предшествующая %d.0%d: %d.0%d\n", arr[0].day, arr[0].month, arr[1].day, arr[1].month);
	if (arr[0].month > 10 && arr[1].month > 10) printf_s("Дата, предшествующая %d.%d: %d.%d\n", arr[0].day, arr[0].month, arr[1].day, arr[1].month); 
